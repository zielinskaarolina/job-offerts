...
<head>
    ...
    <script src="Number_Format.js" defer></script>
    <script src="Current_Date.js" defer></script>
    <script src="Congrats.js" defer></script>
    ...
    <?php
        require('PHP_FORM.php');
    ?>
    <title>Formularz</title>
</head>
<body>
    <button id="openPanelBtn">Pokaż panel</button>
    <form action="PHP_FORM.php" method="post">
        <div id="form-container">
            <span id="submission-date">Data wysłania formularza: <span id="current-date"></span></span>
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" required title="Wprowadz poprawny adres e-mail" class="input-with-placeholder" placeholder="example@mail.com">
            </div>
            <div class="form-group">
                ...
                <select id="phone_code" name="phone_code" required>
                    ...
                    <option value="+1340">Dziewicze Wyspy Stanów Zjednoczonych (+1340)</option>
                ...
                <input type="tel" id="phone" name="phone" required pattern="[0-9\s]{9,13}" title="Wprowadź 9-cyfrowy numer telefonu">
            </div>
            <div class="form-group">
            ...
            <div class="container">
                <div class="range-slider">
                    ...
                    <div class="price-input">
                        <label for="minPriceInput">Minimalna kwota:</label>
                        <div class="input-wrapper">
                            <input type="number" id="minPriceInput" value="0" min="0" max="10000" step="100">
                            <span class="currency">zł</span>
                        </div>
                        <label for="maxPriceInput">Maksymalna Kwota:</label>
                        <div class="input-wrapper">
                            <input type="number" id="maxPriceInput" value="10000" min="0" max="10000" step="100">
                            <span class="currency">zł</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group" id="success-message">
                <button type="submit" value="Wyślij" id="myBtn">Wyślij formularz</button>
            </div>
            ...
            <div id="panel" class="panel">
                ...
                <div class="panel-content">
                    <div class="form-group">
                        <label for="motivation">List Motywacyjny:</label>
                        <textarea id="motivation" name="motivation" rows="12"></textarea>
                    </div>
                    <div class="panel-content">
